...
function speakSomething(what, howMany) {
    // If I enter a number, then a string, it breaks the function. This has better error checking.
    var what = (typeof what === 'string') ? what : 'Default speech';
    var howMany = (typeof howMany === 'number') ? howMany : 10;
...
function addingMachine() {
    ...
    for (var i = 0; i < arguments.length; i += 1) { // Note that arguments is a known property of function. In fact it's an array.
        // grab the number in the next position
